...
public class Board implements PropertyChangeEnabledBoardControls {
    ...
    public Board(final int theWidth, final int theHeight) {
        ...
        if (COUNT > 0) {
            throw new IllegalArgumentException("There should be only one BOARD!");
        }
        COUNT++;
    ...
    public void newGame() {
        ...
        myPcs.firePropertyChange(CURRENT_PIECE, null, myCurrentPiece);
        myPcs.firePropertyChange(NEW_GAME, null, myGameOver);
        myPcs.firePropertyChange(FROZEN_BLOCKS, null,
                new LinkedList<>(myFrozenBlocks));
    }
    ...
    public void down() {
        if (!move(myCurrentPiece.down())) {
            ...
            // TODO Publish Update!
            myPcs.firePropertyChange(CURRENT_PIECE, null, myCurrentPiece);
            myPcs.firePropertyChange(FROZEN_BLOCKS, null, myFrozenBlocks);
        }
    }
    ...
    private void checkRows() {
        ...
        for (final Block[] row : myFrozenBlocks) {
            ...
            if (complete) {
             ...
             // TODO Publish Update!
                myPcs.firePropertyChange(CHECK_ROW, null, completeRows);
            }
        }
    ...
    private void setPoint(final List<Block[]> theBoard,
        ...
        if (isPointOnBoard(theBoard, thePoint)) { 
            ...
            myPcs.firePropertyChange(END_GAME, null, myGameOver);
        }
    }
    ...
    private void prepareNextMovablePiece() {
        ...
        if (share && !myGameOver) {
            // TODO Publish Update!
            myPcs.firePropertyChange(PREVIEW_PIECE, null, myNextPiece);
        }
    }    
